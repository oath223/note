package com.iktz.solrj.subindex;
...
public class SolrOpeDocsDemo {
	...
	public static void addDocs() {
		...
		System.out.println("文档数目："+docs.size());
		try {
			...
			server.add(docs.iterator());//重点在这一步
			//UpdateResponse rsp = req.process(server);
		} catch (Exception e) {
...
//		System.out.println("time elapsed(ms):" + (System.currentTimeMillis() - start));
	...
	public static void query() throws Exception {
		String serverURL = "http://localhost:8080/solr";
